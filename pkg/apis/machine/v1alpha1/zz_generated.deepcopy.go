...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetalSSHKeySpec) DeepCopyInto(out *MetalSSHKeySpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetalSSHKeySpec.
func (in *MetalSSHKeySpec) DeepCopy() *MetalSSHKeySpec {
	if in == nil {
		return nil
	}
	out := new(MetalSSHKeySpec)
	in.DeepCopyInto(out)
	return out
}
