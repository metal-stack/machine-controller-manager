...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*MetalSSHKeySpec)(nil), (*machine.MetalSSHKeySpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_MetalSSHKeySpec_To_machine_MetalSSHKeySpec(a.(*MetalSSHKeySpec), b.(*machine.MetalSSHKeySpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*machine.MetalSSHKeySpec)(nil), (*MetalSSHKeySpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_machine_MetalSSHKeySpec_To_v1alpha1_MetalSSHKeySpec(a.(*machine.MetalSSHKeySpec), b.(*MetalSSHKeySpec), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_MetalMachineClassSpec_To_machine_MetalMachineClassSpec(in *MetalMachineClassSpec, out *machine.MetalMachineClassSpec, s conversion.Scope) error {
	...
	out.Tags = *(*map[string]string)(unsafe.Pointer(&in.Tags))
	out.SSHKeys = *(*[]machine.MetalSSHKeySpec)(unsafe.Pointer(&in.SSHKeys))
...
func autoConvert_v1alpha1_MetalSSHKeySpec_To_machine_MetalSSHKeySpec(in *MetalSSHKeySpec, out *machine.MetalSSHKeySpec, s conversion.Scope) error {
	out.ID = in.ID
	out.Fingerprint = in.Fingerprint
	return nil
}

// Convert_v1alpha1_MetalSSHKeySpec_To_machine_MetalSSHKeySpec is an autogenerated conversion function.
func Convert_v1alpha1_MetalSSHKeySpec_To_machine_MetalSSHKeySpec(in *MetalSSHKeySpec, out *machine.MetalSSHKeySpec, s conversion.Scope) error {
	return autoConvert_v1alpha1_MetalSSHKeySpec_To_machine_MetalSSHKeySpec(in, out, s)
}

func autoConvert_machine_MetalSSHKeySpec_To_v1alpha1_MetalSSHKeySpec(in *machine.MetalSSHKeySpec, out *MetalSSHKeySpec, s conversion.Scope) error {
	out.ID = in.ID
	out.Fingerprint = in.Fingerprint
	return nil
}

// Convert_machine_MetalSSHKeySpec_To_v1alpha1_MetalSSHKeySpec is an autogenerated conversion function.
func Convert_machine_MetalSSHKeySpec_To_v1alpha1_MetalSSHKeySpec(in *machine.MetalSSHKeySpec, out *MetalSSHKeySpec, s conversion.Scope) error {
	return autoConvert_machine_MetalSSHKeySpec_To_v1alpha1_MetalSSHKeySpec(in, out, s)
}
